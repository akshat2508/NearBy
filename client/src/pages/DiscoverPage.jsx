  ...
  return (
    <div className="mx-auto max-w-3xl space-y-6">
      <div className="flex items-center justify-between">
        <h1 className="font-display text-2xl font-semibold tracking-tight text-ink-950">Discover</h1>
        <RadiusSelect value={radiusKm} onChange={setRadiusKm} />
      </div>

      <div className="overflow-hidden rounded-3xl border border-surface-200 shadow-soft">
        <NearbyMap
